...
void* boxBlur(void* arguments){
    ...
    for(i = begin; i< end; i++){
        for(j = 0; j< w; j++){
            ...
            if(i == 0 && j ==0 ){ //top left
                pixelBlur[i][j].R = (pixArray[i][j].R + pixArray[i][j+1].R + pixArray[i+1][j].R +pixArray[i+1][j+1].R)/4;
                pixelBlur[i][j].G = (pixArray[i][j].G + pixArray[i][j+1].G + pixArray[i+1][j].G +pixArray[i+1][j+1].G)/4;
                pixelBlur[i][j].B = (pixArray[i][j].B + pixArray[i][j+1].B + pixArray[i+1][j].B +pixArray[i+1][j+1].B)/4;
                
            }else if(i == 0 && j == (w-1)){ //top right
                pixelBlur[i][j].R = (pixArray[i][j-1].R + pixArray[i+1][j].R + pixArray[i][j].R +pixArray[i+1][j-1].R)/4;
                pixelBlur[i][j].G = (pixArray[i][j-1].G + pixArray[i+1][j].G + pixArray[i][j].G +pixArray[i+1][j-1].G)/4;
                pixelBlur[i][j].B = (pixArray[i][j-1].B + pixArray[i+1][j].B + pixArray[i][j].B +pixArray[i+1][j-1].B)/4;
                
            }else if (i == (h-1) && j == 0){ //bottom left
                pixelBlur[i][j].R = (pixArray[i][j].R + pixArray[i-1][j].R + pixArray[i-1][j+1].R +pixArray[i][j+1].R)/4;
                pixelBlur[i][j].G = (pixArray[i][j].G + pixArray[i-1][j].G + pixArray[i-1][j+1].G +pixArray[i][j+1].G)/4;
                pixelBlur[i][j].B = (pixArray[i][j].B + pixArray[i-1][j].B + pixArray[i-1][j+1].B +pixArray[i][j+1].B)/4;
                
            }else if(i == (h-1) && j == (w-1)){ //bottom right
                pixelBlur[i][j].R = (pixArray[i][j].R + pixArray[i-1][j-1].R + pixArray[i-1][j].R +pixArray[i][j-1].R)/4;
                pixelBlur[i][j].G = (pixArray[i][j].G + pixArray[i-1][j-1].G + pixArray[i-1][j].G +pixArray[i][j-1].G)/4;
                pixelBlur[i][j].B = (pixArray[i][j].B + pixArray[i-1][j-1].B + pixArray[i-1][j].B +pixArray[i][j-1].B)/4;
                
            }else if(i == 0){                  //top
                pixelBlur[i][j].R = (pixArray[i][j].R + pixArray[i][j-1].R + pixArray[i][j+1].R + pixArray[i+1][j+1].R + pixArray[i+1][j-1].R + pixArray[i+1][j].R)/6;
                pixelBlur[i][j].G = (pixArray[i][j].G + pixArray[i][j-1].G + pixArray[i][j+1].G + pixArray[i+1][j+1].G + pixArray[i+1][j-1].G + pixArray[i+1][j].G)/6;
                pixelBlur[i][j].B = (pixArray[i][j].B + pixArray[i][j-1].B + pixArray[i][j+1].B + pixArray[i+1][j+1].B + pixArray[i+1][j-1].B + pixArray[i+1][j].B)/6;
                
            }else if(i == (h-1)){              //bottom
                pixelBlur[i][j].R = (pixArray[i][j].R + pixArray[i][j-1].R + pixArray[i][j+1].R + pixArray[i-1][j-1].R + pixArray[i-1][j].R + pixArray[i-1][j+1].R)/6;
                pixelBlur[i][j].G = (pixArray[i][j].G + pixArray[i][j-1].G + pixArray[i][j+1].G + pixArray[i-1][j-1].G + pixArray[i-1][j].G + pixArray[i-1][j+1].G)/6;
                pixelBlur[i][j].B = (pixArray[i][j].B + pixArray[i][j-1].B + pixArray[i][j+1].B + pixArray[i-1][j-1].B + pixArray[i-1][j].B + pixArray[i-1][j+1].B)/6;
                
            }else if (j == 0){                 //left
                pixelBlur[i][j].R = (pixArray[i][j].R + pixArray[i-1][j].R + pixArray[i+1][j].R + pixArray[i-1][j+1].R + pixArray[i][j+1].R + pixArray[i+1][j+1].R)/6;
                pixelBlur[i][j].G = (pixArray[i][j].G + pixArray[i-1][j].G + pixArray[i+1][j].G + pixArray[i-1][j+1].G + pixArray[i][j+1].G + pixArray[i+1][j+1].G)/6;
                pixelBlur[i][j].B = (pixArray[i][j].B + pixArray[i-1][j].B + pixArray[i+1][j].B + pixArray[i-1][j+1].B + pixArray[i][j+1].B + pixArray[i+1][j+1].B)/6;
            ...
            }else{                             //normal centered pixel
                pixelBlur[i][j].R = (pixArray[i-1][j-1].R + pixArray[i-1][j].R + pixArray[i-1][j+1].R +
                                     pixArray[i][j-1].R + pixArray[i][j].R + pixArray[i][j+1].R +
                                     pixArray[i+1][j-1].R + pixArray[i+1][j].R + pixArray[i+1][j+1].R)/9;
                
                pixelBlur[i][j].G = (pixArray[i-1][j-1].G + pixArray[i-1][j].G + pixArray[i-1][j+1].G +
                                     pixArray[i][j-1].G + pixArray[i][j].G + pixArray[i][j+1].G +
                                     pixArray[i+1][j-1].G + pixArray[i+1][j].G + pixArray[i+1][j+1].G)/9;
                
                pixelBlur[i][j].B = (pixArray[i-1][j-1].B + pixArray[i-1][j].B + pixArray[i-1][j+1].B +
                                     pixArray[i][j-1].B + pixArray[i][j].B + pixArray[i][j+1].B +
                                     pixArray[i+1][j-1].B + pixArray[i+1][j].B + pixArray[i+1][j+1].B)/9;
